...
vecAssembler = VectorAssembler(inputCols=["total_reviews", "total_positive"], outputCol="features")
...
ax1.scatter(df_pd.total_reviews,df_pd.total_negative,c=df_pd.prediction,cmap='rainbow',  s=80, alpha=0.8)
plt.xlabel('Количество отзывов', fontsize=16)
plt.ylabel('Количество негативных отзывов', fontsize=16)
plt.savefig('Clustering_plus.png')